...
<div class="col-md-7 col-md-offset-2">
	<div class="box box-info">
	  <div class="box-header with-border">
	    <h3 class="box-title">banner（推荐尺寸：200px * 200px;）</h3>
	  </div>
	  <!-- /.box-header -->
	  <!-- form start -->
	  <form class="form-horizontal" id="updateForm">
	    ...
	    <div class="box-body">
	      <div class="form-group">
	        <label for="cateName" class="col-sm-2 control-label">种类名</label>
	
	        <div class="col-sm-10">
	          <input type="text" class="form-control" id="cateName" name="cateName" placeholder="请输入种类名">
	        </div>
	      </div>
	      <div class="form-group">
...
<script type="text/javascript" src="${ctx}/resource/js/category/category_update.js"></script>
</body>
</html>